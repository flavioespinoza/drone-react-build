...
class Step_ClaimOtherPerson extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      _selected: ""
...
Step_ClaimOtherPerson.propTypes = {
...
export default connect(mapStateToProps)(withStyles(style)(Step_ClaimOtherPerson));
