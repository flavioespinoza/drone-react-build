...
import ProofingAnnotations from "../Annotations/Proofing";
...
class Step4 extends React.Component {
  ...
  render() {
    ...
    const group = {
      id: "proofing_annotations",
      ariaLabel: "Proofing Annotations",
      groupType: "BasisOfVerification",
      groupName: "proofing_annotations_1",
      groupInfoText: "Basis of Verification",
      groupSubText: "(select best that applies to this context)",
      items: ProofingAnnotations
    };
