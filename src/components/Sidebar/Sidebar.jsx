...
class Sidebar extends React.Component {
  ...
  // while on the src/views/forms/<ComponentName>.jsx - route /admin/<component-name>
  ...
  render() {
      ...
      <div className={userWrapperClass}>
        ...
        <List className={classes.list}>
          <ListItem className={classes.item + " " + classes.userItem}>
            ...
            >
              <ListItemText
                primary={rtlActive ? "تانيا أندرو" : "Jonathan Hare"}
                secondary={
                  <b
                    className={
                      caret +
    ...
    var brand = (
      <div className={logoClasses}>
        <a
          href="https://www.webshield.io?ref=mdpr-sidebar"
          target="_blank"
          className={logoMini}
        >
