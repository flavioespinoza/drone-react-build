...
let id_url = 'exemplar.pd.authnet.webshield.io/'

const ProofingAnnotations = [
  {
		id: `${id_url}${uuid()}`,
  ...
  },
  {
    ...
    annotator: undefined,
    annotationText:
      'I got this information from a database or application managed by an organization i work fo',
    evidence: {
...
export default ProofingAnnotations;
